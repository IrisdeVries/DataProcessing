...
def scrape_movie_page(dom):
    ...
    # genre
    # for movie in dom.by_tag('td#overview-top'): 
    #     genre = movie.by_class('infobar')[0].by_tag('a')[0].by_tag('span.itemprop')[0][0]
    ...
    # put in list
    movies.extend([title, duration, directors, writers, actors, rating, n_ratings])

    # Return list of properties movies
    return movies
